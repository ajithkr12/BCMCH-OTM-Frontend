...
export const GetAllMasters = async () =>{
    try {
        const response =  await axios.get(ConstantURL.GetAll, {'Content-Type': 'application/json', 'Accept':"*/*"});
...
export const GetSurgeryList = async (_searchKeyword="", _pageNumber=1, _rowsPerPage =20) =>{
    try {
        ...
        console.log( " surgery list : ", response.data.data)
        return response.data.data;
    } 
    catch (error) {
        const _error =
...
export const GetOtherDepartmentSurgeons = async (_departments=[], _pageNumber=1, _rowsOfPage =100) =>{
    // departments
    // pageNumber
    // rowsOfPage
    // searchKeyword
    ...
    _departmentstringArray = _departmentstringArray.substring(0, _departmentstringArray.length-1);
    ...
    try {
        ...
        console.log( "department surgeons : ", response.data.data)
        return response.data.data;
    } 
    catch (error) {
        const _error =
